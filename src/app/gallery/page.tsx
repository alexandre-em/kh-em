  ...
  return (
    <>
      ...
      <i className="font-thin text-sm text-gray-500">
        Here is all of my works with their informations. If you are interested in buying one (or more) of them, please send me an
        email with the(ir) link(s) to check their availabilities.
      </i>
